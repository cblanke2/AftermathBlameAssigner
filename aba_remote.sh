...
uninstall_script () {
	...
	[[ $(echo $(source /etc/os-release && echo $ID)) == "centos" || $(echo $(source /etc/os-release && echo $ID)) == "rhel" ]] && [[ $(echo $(source /etc/os-release && echo $VERSION_ID)) -eq 7 ]] && [[ $(echo $( /usr/local/bin/pip3 list --not-required)) == *" psutil "* ]] &&  /usr/local/bin/pip3 uninstall -y psutil
	[[ $(echo $(source /etc/os-release && echo $ID)) == "centos" || $(echo $(source /etc/os-release && echo $ID)) == "rhel" ]] && [[ $(echo $(source /etc/os-release && echo $VERSION_ID)) -eq 7 ]] && [[ $(echo $( /usr/local/bin/pip3 list --not-required)) == *" setuptools "* ]] &&  /usr/local/bin/pip3 uninstall -y setuptools
	[[ $(echo $(source /etc/os-release && echo $ID)) == "centos" || $(echo $(source /etc/os-release && echo $ID)) == "rhel" ]] && [[ $(echo $(source /etc/os-release && echo $VERSION_ID)) -eq 7 ]] && [[ $(echo $( /usr/local/bin/pip3 list --not-required)) == *" wheel "* ]] &&  /usr/local/bin/pip3 uninstall -y wheel
	[[ $(echo $(source /etc/os-release && echo $ID)) == "centos" || $(echo $(source /etc/os-release && echo $ID)) == "rhel" ]] && [[ $(echo $(source /etc/os-release && echo $VERSION_ID)) -eq 7 ]] && [[ $(echo $( /usr/local/bin/pip3 list --not-required)) == *" pip "* ]] &&  /usr/local/bin/pip3 uninstall -y pip
	[[ $(echo $(source /etc/os-release && echo $ID)) == "centos" || $(echo $(source /etc/os-release && echo $ID)) == "rhel" ]] && [[ $(echo $(source /etc/os-release && echo $VERSION_ID)) -eq 7 ]] && rpm -e python36-devel python36-libs python36 epel-release
