...
* Remove any unneeded dependencies → `sudo rpm -e python36-devel python36-libs python36; sudo rpm -m epel-release; sudo rpm -e gcc; sudo yum history sync; sudo yum clean all; sudo yum -y autoremove; hash -r`
